  ...
  nodes: [
    {
      ...
      relations: [
        { type: 'system', target: 'space-relations', explanation: 'AT 属于空间关系系统，用“点”完成定位。' },
        { type: 'contrast', target: 'to', explanation: 'AT 锁定目标点；TO 表示朝目标移动或延伸。' },
        { type: 'contrast', target: 'in', explanation: 'AT 是点定位；IN 强调在边界内部。' },
      ],
    },
    {
      ...
      relations: [
        { type: 'system', target: 'space-relations', explanation: 'ON 用表面接触来表达空间关系。' },
        { type: 'contrast', target: 'in', explanation: 'ON 在表面接触；IN 在边界内部。' },
        { type: 'contrast', target: 'at', explanation: 'ON 保留接触表面的画面；AT 只做点式定位。' },
      ],
    },
    {
      ...
      relations: [
        { type: 'system', target: 'space-relations', explanation: 'IN 用边界内部组织空间关系。' },
        { type: 'combination', target: 'into', explanation: 'IN 的“内部”与 TO 的“朝向”合在一起，形成 INTO 的进入画面。' },
        { type: 'contrast', target: 'into', explanation: 'IN 是内部状态；INTO 是穿过边界进入内部的过程。' },
        { type: 'contrast', target: 'on', explanation: 'IN 强调内部容纳；ON 强调表面接触。' },
      ],
    },
    {
      ...
      deep: { logic: 'TO 给出方向和终点，可连接移动、给予、注意力等动作。', scenes: 'go to school、give it to me、listen to music。', structures: '动词 + to + 目标。', chineseTrap: 'TO 不等于静态“在”；它保留朝向或连接感。', studyTip: '用箭头标出从哪里朝哪里去。' },
      relations: [
        { type: 'system', target: 'space-relations', explanation: 'TO 在空间关系系统中表达方向与终点。' },
        { type: 'contrast', target: 'at', explanation: 'TO 是朝目标的箭头；AT 是已经锁定的目标点。' },
        { type: 'combination', target: 'into', explanation: 'TO 的方向感进入 IN 的边界内部，就得到 INTO 的动态进入。' },
        { type: 'combination', target: 'too-to', explanation: 'TO 可进入 TOO...TO... 结构，标出“过度到无法做某事”的后续动作。' },
      ],
    },
    {
      ...
      relations: [
        { type: 'system', target: 'space-relations', explanation: 'INTO 通过跨越边界表达动态空间关系。' },
        { type: 'combination', target: 'in', explanation: 'INTO 保留 IN 的内部落点，同时加入动态进入。' },
        { type: 'combination', target: 'to', explanation: 'INTO 保留 TO 的方向箭头，但终点必须在边界之内。' },
        { type: 'contrast', target: 'in', explanation: 'IN 描述位置已在内部；INTO 描述进入内部的变化。' },
      ],
    },
    {
      ...
      relations: [
        { type: 'system', target: 'state-action', explanation: 'BE 是状态与动作系统中的基础状态连接词。' },
        { type: 'growth', target: 'ing', explanation: 'BE 与 -ING 组合，把主体放进正在展开的动作过程。' },
      ],
    },
    {
      ...
      relations: [
        { type: 'system', target: 'state-action', explanation: '-ING 在状态与动作系统中把动作呈现为过程。' },
        { type: 'growth', target: 'be', explanation: '-ING 与 BE 相连时，形成“主体正处于某动作过程”的结构。' },
      ],
    },
    {
      ...
      relations: [
        { type: 'system', target: 'information-structure', explanation: 'THE 在信息结构系统中标记可共同定位的信息。' },
        { type: 'growth', target: 'if', explanation: 'THE 锁定对象；IF 组织条件，两者都帮助听者追踪信息。' },
      ],
    },
    {
      ...
      relations: [
        { type: 'system', target: 'information-structure', explanation: 'IF 在信息结构系统中建立条件与结果的连接。' },
        { type: 'contrast', target: 'too-to', explanation: 'IF 打开一个尚未确定的条件；TOO...TO... 描述程度已经过头的结果。' },
      ],
    },
    {
      id: 'too-to', word: 'TOO...TO...', systemId: 'information-structure',
      ...
      relations: [
        { type: 'system', target: 'information-structure', explanation: 'TOO...TO... 在信息结构系统中表达程度造成的结果。' },
        { type: 'combination', target: 'to', explanation: 'TOO 与 TO 共同组成 TOO...TO...：程度过头，使 TO 后的动作无法实现。' },
        { type: 'contrast', target: 'if', explanation: 'TOO...TO... 给出已经形成的过度结果；IF 只提出一个可能条件。' },
      ],
    },
    {
      ...
      relations: [
        { type: 'system', target: 'attention', explanation: 'SEE 在注意力系统中标记视觉感知的结果。' },
        { type: 'contrast', target: 'look', explanation: 'SEE 是看见的结果；LOOK 是把目光主动投向某方向。' },
        { type: 'contrast', target: 'watch', explanation: 'SEE 可是瞬间结果；WATCH 要持续关注变化过程。' },
      ],
    },
    {
      ...
      relations: [
        { type: 'system', target: 'attention', explanation: 'LOOK 在注意力系统中表达主动投向的视觉方向。' },
        { type: 'contrast', target: 'see', explanation: 'LOOK 是主动看向；SEE 是已经看见的结果。' },
        { type: 'contrast', target: 'watch', explanation: 'LOOK 可以是一眼的方向动作；WATCH 要持续跟随变化。' },
      ],
    },
    {
      ...
      relations: [
        { type: 'system', target: 'attention', explanation: 'WATCH 在注意力系统中表达持续关注变化过程。' },
        { type: 'contrast', target: 'see', explanation: 'WATCH 是持续过程；SEE 是获得视觉结果。' },
        { type: 'contrast', target: 'look', explanation: 'WATCH 比 LOOK 多出持续时间和对象变化。' },
      ],
    },
  ],
};
